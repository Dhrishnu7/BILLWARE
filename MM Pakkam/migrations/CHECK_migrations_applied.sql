...
WITH expected_tables(tbl, migration) AS (VALUES
    ...
    ('bank_reconciliations', 'add_bank_reconciliations.sql')
),
expected_columns(tbl, col, migration) AS (VALUES
    ...
    ('supplier_payments',   'payment_mode',   'add_payment_modes.sql'),
    ('customer_payments',   'payment_mode',   'add_payment_modes.sql')
)
